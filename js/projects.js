...
const PROJECTS = [
  ...
  // ── Tools ──────────────────────────────────────────────────────────────
  {
    ...
    skills: ["Writing workshop", "Idea generation", "K2", "K3", "Lucy Calkins", "Drawing as writing", "ESL"],
  ...
  },
  {
    ...
    skills: ["Salary planning", "China", "Budget", "Expat", "Teacher finance"],
  ...
  },
  {
    ...
    skills: ["Random picker", "Names", "Turn-taking", "Classroom", "Equity"],
  ...
  },
  {
    ...
    type: "tool",
    description: "Teacher seating charts from a comma-separated name list. Rows, pairs, groups, carpet, or custom grid. Drag to swap, keep-apart constraints, randomise, save on device, print-friendly chart.",
    category: "Classroom",
    subject: "Classroom management",
    skills: ["seating", "grouping", "classroom management", "print"],
  ...
  },
  {
    ...
    category: "Classroom",
    subject: "Classroom management",
    skills: ["Grouping", "Partners", "Random teams", "Classroom", "Collaboration"],
  ...
  },
  {
    ...
    skills: ["Volume awareness", "Self-regulation", "Quiet signal", "Classroom game"],
  ...
  },
  {
    ...
    category: "Classroom",
    subject: "Classroom management",
    skills: ["Timer", "Transitions", "Focus", "Visual timer", "Classroom"],
  ...
  },
  {
    ...
    category: "Classroom",
    subject: "IB PYP",
    skills: ["IB PYP", "Learner Profile", "ATLs", "Transdisciplinary themes", "Reference"],
  ...
  },
  {
    ...
    category: "Literacy",
    subject: "Literacy / Writing",
    skills: ["Story writing", "Branching narrative", "CYOA", "Authoring", "Literacy"],
